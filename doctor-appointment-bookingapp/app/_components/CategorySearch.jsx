      ...
      <div className="grid grid-cols-3 mt-5 md:grid-cols-4 lg:grid-cols-6 ">
        {categoryList.length > 0
          ...
          gap-2 hover:scale-110 transition-all ease-in-out"
                  >
                    <Image
                      src={item.attributes?.Icon?.data.attributes?.url} //The question marks (?.) are used for optional chaining in JavaScript. They allow accessing nested properties safely, avoiding errors if any intermediate property is null or undefined.
                      alt="icon"
                      width={40}
                      height={40}
                    />
